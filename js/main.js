...
// if there is anny text in the item field add that text to the todo list
...
function completeItem() {
    ...
    var id = parent.id;
    var value = item.innerText; 
// moving data tru different arrays
    if (id === 'todo') {
       data.todo.splice(data.todo.indexOf(value), 1);
...
// inserting items on top of a previous instead of beneath it
